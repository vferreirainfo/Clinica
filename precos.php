      ...
      <div class="col-lg-4">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fa fa-check-circle"></i></span><strong>5 Users</strong></li>
              <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>50GB Storage</li>
              <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>Unlimited Public Projects</li>
              <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>Community Access</li>
              <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>Unlimited Private Projects</li>
              <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>Dedicated Phone Support</li>
