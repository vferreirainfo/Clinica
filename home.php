		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="services.php" class="nav-link">Gestão de Médicos</a></li>
					<li class="nav-item"><a href="cases.php" class="nav-link">Gestão de Pacientes</a></li>
					<li class="nav-item"><a href="blog.php" class="nav-link">Gestão de Exames</a></li>
					<li class="nav-item"><a href="contact.php" class="nav-link">Enviar sms</a></li>
					<li class="nav-item cta"><a href="#" class="nav-link">Consulta avançada</a></li>
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				<div class="col-md-8 ftco-animate mt-5 pt-md-5" data-scrollax=" properties: { translateY: '70%' }">
					<div class="row">
						<div class="col-md-7">
							<p class="mb-4 pl-md-5 line" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Olá. Nos links abaixo pode obter ficheiro binário global ou especifico</p>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="ftco-intro">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-7">
					<div class="row no-gutters d-flex align-items-center" style="display:flex; justify-content:center; align-items:center">
						<div class="col-sm-4 align-self-stretch ftco-animate" style="margin-right:15px">
							<div class="services-1">
								<div class="line"></div>
								<div class="icon"><span class="flaticon-bolt"></span></div>
								<div class="media-body">
									<h3 class="heading mb-3">Obter ficheiro binário de médicos</h3>
								</div>
							</div>      
						</div>
						<div class="col-sm-4  align-self-stretch ftco-animate" style="margin-right:15px">
							<div class="services-1 color-1">
								...
								<div class="media-body">
									<h3 class="heading mb-3">Obter ficheiro binário de pacientes</h3>
								</div>
							</div>      
						</div>
	...
	<footer class="ftco-footer ftco-footer-2 ftco-section">
		<div class="container">
			<div class="row mb-5">
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4 ml-md-5">
						...
						<ul class="list-unstyled">
							<li><a href="#" class="py-2 d-block">Gestão Médicos</a></li>
							<li><a href="#" class="py-2 d-block">Gestão Pacientes</a></li>
							<li><a href="#" class="py-2 d-block">Efetuar pesquisa avançada</a></li>
							<li><a href="#" class="py-2 d-block">Obter relatórios PDF</a></li>
							<li><a href="#" class="py-2 d-block">Ficheiro binário global</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2">Contacto suporte ?</h2>
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon fa fa-map marker"></span><span class="text">203 Avenida dos Lusiadas, Viana do Castelo </span></li>
								<li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+2589440111</span></a></li>
								<li><a href="#"><span class="icon fa fa-paper-plane pr-4"></span><span class="text">info@teckmac-solutions.com</span></a></li>
							</ul>
						</div>
					</div>
				</div>
